...
# ------------------------------------------------------------
SCHEDULE_TIMES = ("15:00", "16:00", "17:00", "22:00")
SCHEDULE_EVENTS = (
    ("Коноктор жыйыны",   "Қонақтар жиыны"),    # event 1  (e.g. guests gather)   @ 15:00
    ("Нике кыюу аземи",   "Неке қию рәсімі"),    # event 2  (e.g. ceremony)        @ 16:00
    ("Банкет",            "Банкет"),             # event 3  (e.g. banquet)         @ 17:00
    ("Кеченин аякташы",   "Кештің аяқталуы"),    # event 4  (e.g. end of evening)  @ 22:00
)
...
# ------------------------------------------------------------
LETTER_GREETING = (
    "Урматтуу биздин туугандарыбыз жана досторубуз!",
    "Құрметті біздің туғандарымыз және достарымыз!",
)
LETTER_BODY_1 = (
...
RSVP_MAP     = ("📍 Картадан көрүү үчүн басыңыз", "📍 Картадан көру үшін басыңыз")     # "tap to view on map"
