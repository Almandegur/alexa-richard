...
LETTER_GREETING = (
    ...
    "Құрметті құда-жекжаттар, туғандар, достар",
)
LETTER_BODY_1 = (
...
RSVP_HOSTSLAB = ("Урматтоо менен,", "Құрметпен,")  # closing salutation, above the host names
HOSTS_SUB = ("той ээлери", "той иелері")            # small italic role line, BELOW the host names
